...
import { Input, Textarea } from '../../../../components/common/Forms/FormsControls'
  ...
  return (
    <form className={st.aboutForm} onSubmit={props.handleSubmit}>
      <div className={st.col1}>
        <div>
          Full name: <Field name={'fullName'} component={Input} validate={[required, maxNameLength, minNameLength]} placeholder={'Alex Silverhand'} />
        </div>
        <div>
          About me: <Field name={'aboutMe'} component={Textarea} validate={[maxAboutMeLength]} placeholder={'Write something about yourself'} />
        </div>
      ...
      <div className={st.col2}>
        <div>
          ...
          <Field name={'lookingForAJob'} component={Input} type={'checkbox'} placeholder={'Alex Silverhand'} />
        </div>
        <div>
          Skills: <br />
          <Field name={'lookingForAJobDescription'} component={Textarea} validate={[maxSkillsLength]} placeholder={'My professional skills'} />
        </div>
      </div>
