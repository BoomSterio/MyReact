        ...
        <Form>
          ...
          <div className={st.formItem}>
            ...
            <Field
              ...
              style={{ width: '11vw', marginRight: '10px' }}
            />
            <span onClick={onTogglePassVisibility}>
              {isPassVisible ? <EyeOutlined className={st.passIcon} /> : <EyeInvisibleOutlined className={st.passIcon} />}
            </span>
